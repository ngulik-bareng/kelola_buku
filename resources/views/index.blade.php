  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/icons/logo.png" alt="" width="30" /><span class="text-1000 fs-1 ms-2 fw-medium">Rental<span class="fw-bold">Buku</span></span></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex py-3 py-lg-0">
              <button class="btn btn-link text-1000 fw-medium order-1 order-lg-0" type="button">Login</button>
              <a class="btn btn-outline-primary rounded-pill order-0" href="/register">Daftar</a>
              @if (Auth::user())
              <a class="btn mx-3 btn-outline-primary rounded-pill order-0" href="/dashboard">Dashboard</a>
              @endif
            </form>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
              <h1 class="fw-medium">Want anything to be<br />easy with <span class="fw-bold">Rent Book.</span></h1>
              <p class="mt-3 mb-4"> <span class="fw-medium">Rent Book </span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas quis consequuntur sunt itaque odio, natus officiis perspiciatis in voluptatibus incidunt?</p><a class="btn btn-lg btn-primary hover-top btn-glow" href="/login">Get Started </a>
            </div>
          </div>
        </div>
        <!-- end of .container-->
                    ...
                    <div class="row  d-flex justify-content-center align-items-center align-content-center">
                        ...
                        @foreach($books as $book)
                            <div class="col-lg-3 col-md-3 col-sm-12  mb-3">
                                <div class="card">
                                   @if($book->cover!= '')
                                    <img src="{{ asset('storage/cover/'.$book->cover)}}" alt="" style="height: 250px;  object-fit:cover">
                                   @else
                                   <div class="p-5 " style="height: 250px;  object-fit:cover">
      ...
      <section class="pt-4 pt-md-6">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 text-lg-center"><img class="img-fluid mb-5 mb-md-0" src="{{asset('/frontend/assets/img/illustrations/2.png')}}"/></div>
          ...
          <div class="card py-5 px-5 border-0 shadow-sm">
            <div class="card-body">
              <div class="row flex-center">
                ...
                <div class="col-12 col-lg-6 text-lg-end"><a class="btn btn-lg btn-primary hover-top btn-glow text-end" href="#">Subscribe Now</a></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="bg-200 pt-9 pb-0">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle" src="assets/img/icons/logo.png" alt="" width="30" /><span class="d-inline-block text-1000 fs-1 ms-2 fw-medium lh-base">SMKN<span class="fw-bold">Bantarkalong</span></span></a>
              <p class="my-3"> <span class="fw-medium">Sekolah</span>Menengah Kejuruan<br />Terbaik</p>
              ...
              <p class="text-400 my-3">&copy; Yusup Supriatna 2022</p>
            </div>
            <div class="col-6 col-sm-4 col-lg-3 mb-3">
              <h5 class="lh-lg">Jurusan</h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">RPL</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">TKJ</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">TELIN</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">FARMASI</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">OTKP</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">TKR</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">TBSM</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-4 col-lg-3 mb-3">
              <h5 class="lh-lg">Ekskul</h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">PASKIBRA</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">PRAMUKA</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">PMR</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">FUTSAL</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">VOLLY BALL</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">BASKET</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">ANGGAR</a></li>
              </ul>
            </div>
            <div class="col-12 col-sm-4 col-lg-2 mb-3 ps-xxl-7 ps-xl-5">
              <h5 class="lh-lg">Social Media</h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">@smknbantarkalong</a></li>
                <li class="lh-lg"><a class="text-900 text-decoration-none" href="#!">smknbantarkalong.official</a></li>
              </ul>
            </div>
            <hr class="opacity-25" />
            <div class="text-400 text-center">
              <p>Copy Right&nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a class="text-900" href="https://themewagon.com/" target="_blank">Yusup Supriatna 2022</a>
              </p>
            </div>
          </div>
        </div>
